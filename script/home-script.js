document.addEventListener('DOMContentLoaded', function () {
    ...
    const projects = [
        { name: 'Arduino Robot Line Follower', description: 'This repository contains the code and resources for a line tracing robot built using an Arduino Nano, 4 sensors, and 2 motors. The robot is programmed to follow a line on the ground using the sensor inputs to adjust its movements.', imageUrl: '../images/Line Robot.jpg', link: 'https://github.com/pattana1902/Arduino-Robot-Line-Follower-' },
        { name: 'ESP32 Smart Door', description: 'This repository contains the code and resources for building a smart door system using an ESP32 microcontroller, fingerprint sensor, keypad, and relay module. The system allows users to unlock the door using either their registered fingerprints or a passcode entered on the keypad.', imageUrl: '../images/ESP32-Fingerprint-Lock.jpg', link: 'https://github.com/pattana1902/ESP32-Smart-Door' },
        { name: 'LIFF Line Collect Data ', description: 'LIFF applications are web apps integrated with the LINE messaging platform, allowing developers to create engaging experiences within the LINE app ecosystem.', imageUrl: '../images/screencapture-quickstart-liff-vescp7-stackblitz-io-2024-03-21-02_19_50.png', link : 'https://github.com/pattana1902/LIFF-Line-Collect-Data?tab=readme-ov-file' }
