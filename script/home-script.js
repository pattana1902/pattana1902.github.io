document.addEventListener('DOMContentLoaded', function () {
    ...
    const projects = [
        ...
        { name: 'LIFF Line Collect Data ', description: 'LIFF applications are web apps integrated with the LINE messaging platform, allowing developers to create engaging experiences within the LINE app ecosystem.', imageUrl: 'https://i.ibb.co/kJZTBZ5/screencapture-quickstart-liff-vescp7-stackblitz-io-2024-03-21-02-19-50.png', link : 'https://github.com/pattana1902/LIFF-Line-Collect-Data?tab=readme-ov-file' }
